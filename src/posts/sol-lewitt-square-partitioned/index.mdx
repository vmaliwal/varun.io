...
The goal of this post is to understand how to recreate Sol LeWitt's <AnimatedLink to="https://www.tate.org.uk/art/artworks/lewitt-a-square-divided-horizontally-and-vertically-into-four-equal-parts-each-with-a-p77013">A Square Divided Horizontally and Vertically into Four Equal Parts</AnimatedLink> artwork in Javascript. We will use <AnimatedLink to="https://p5js.org">p5js</AnimatedLink>, a popular tool for creative coding. Let's get started!
